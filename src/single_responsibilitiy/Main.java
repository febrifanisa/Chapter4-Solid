...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            bookService.saveBook(1, "Java Programming", "Tech Publisher");  // Harus melempar Exception "Duplicate single_responsibility.Book"
        } catch (Exception e) {
        ...
        if (book != null) {
            System.out.println("Buku ditemukan: " + book.getName() + " dengan ID single_responsibility.Author: " + book.getAuthorId());
        } else {
